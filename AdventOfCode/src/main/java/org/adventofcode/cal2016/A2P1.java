...
@CalenderAssignment(calendarName = "2016", assignmentName = "Bathroom Security", number = 3, description = "On a keypad follow direction on each line of input, what is the code?")
