...
@CalenderAssignment(calendarName = "2016", assignmentName = "Signals and Noise: Least common", number = 12, description = "Find the error-corrected repetition code")
public class A6P2 extends Assignment {
    ...
    public void run(ActionEvent event) {
        ...
        String codeword = "";
        for (int i = 0; i < counts.size(); i++) {
            int length = counts.get(i).size();
            codeword += counts.get(i).get(length-1).getKey();
        }
