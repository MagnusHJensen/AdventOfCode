...
@CalenderAssignment(calendarName = "2021", assignmentName = "Giant Squid", number = 7, description = "Placeholder.")
public class A4P1 extends Assignment {
	...
	public void run(ActionEvent actionEvent) {
		...
		int[][] winnerBoard = boards.get(winnerBoardIdx);
		boolean[][] winnerBoardSlots = filledSlots.get(winnerBoardIdx);
		...
		output.setText("Board winner: " + (winnerBoardIdx + 1) + "\nWinner number: " + winnerNumber + "\nResult: " + (unmarkedSum * winnerNumber));
